 ...
 */
public class NewSwervePoseEstimator {
  ...
  private final NewTimeInterpolatableBuffer<Pose2d> m_poseBuffer;
  ...
  public NewSwervePoseEstimator(
    ...
    m_poseBuffer = NewTimeInterpolatableBuffer.createBuffer(1.5);
