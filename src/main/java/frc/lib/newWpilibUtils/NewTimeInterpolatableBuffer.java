package frc.lib.newWpilibUtils;
 ...
 */
public class NewTimeInterpolatableBuffer<T> {
  ...
  private NewTimeInterpolatableBuffer(
   ...
   */
  public static <T> NewTimeInterpolatableBuffer<T> createBuffer(
      InterpolateFunction<T> interpolateFunction, double historySizeSeconds) {
    return new NewTimeInterpolatableBuffer<>(interpolateFunction, historySizeSeconds);
  }
   ...
   * @return The new TimeInterpolatableBuffer.
   */
  public static <T extends Interpolatable<T>> NewTimeInterpolatableBuffer<T> createBuffer(
      double historySizeSeconds) {
    return new NewTimeInterpolatableBuffer<>(Interpolatable::interpolate, historySizeSeconds);
  }
   ...
   * @return The new TimeInterpolatableBuffer.
   */
  public static NewTimeInterpolatableBuffer<Double> createDoubleBuffer(double historySizeSeconds) {
    return new NewTimeInterpolatableBuffer<>(MathUtil::interpolate, historySizeSeconds);
  }
