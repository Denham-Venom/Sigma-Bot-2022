...
public class Bottom5BallMiddle extends SequentialCommandGroup {
  ...
  public Bottom5BallMiddle(Swerve s_Swerve, Shooter m_Shooter) {
    ...
    addCommands(
        ...
        new InstantCommand(() -> s_Swerve.resetOdometry(bottom5BallMiddlePart1.getInitialPose())),
        //Deploys the intake
